...
# устанавливаем фавикон в окне приложения
icon = QIcon()
...
# устанавливаем положение и размер кнопки для Закрытьа из программы в родительском окне (window)
...
def log_in():
    if line_login.text() == 'admin' and line_password.text() == 'admin':
        ...
        QMessageBox.information(window, 'Внимание!', "Вы ввели не правильный логин или пароль!!!", buttons=QMessageBox.Ok)
